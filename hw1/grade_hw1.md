...
-   Is the homework submitted (git tag time) before deadline? Take 10 pts off per day for late submission.
    ...
    **See git section below for tag problem. I used as submission deadline the time of last commit in main branch.**
...
### Completeness, correctness and efficiency of solution: 66/80
...
-   Q3 (15/20)
    ...
    **Header included in 3.5 and 3.6**
...
-   Q5 (1/10)
    ...
    **Only output and interpretation provided for calendar**
...
-   Is the hw1 submission tagged?
    ...
    **Tagged submission is incomplete. I graded the files in the hw1 folder in the main branch.**
