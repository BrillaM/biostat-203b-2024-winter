...
mimic_icu_cohort <- mimic_icu_cohort |>
  mutate(
    ...
    admission_location = fct_lump(admission_location , n =4,
                                   other_level = "other "),
    discharge_location = fct_lump(diccharge_location, n =4,
                                 other_level = "other")
    )

mimic_icu_cohort$race <- 
  fct_collapse(mimic_icu_cohort$race,
ASIAN =  c("ASIAN",
          "ASIAN - ASIAN INDIAN", "ASTAN - CHINESE",
...
WHITE = c("WHITE","WHITE - BRIAZILIAN",
