...
```
**answer**: For the time, the fastest function is `fread` in the data.table package. The default parsed data types are different for these three functions. 'fread' uses the least memory.
...
```
**answer**: The system run time cut half from the original version. The memory used is become 1/3 of original version.
